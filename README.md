...
## Sobre o projeto
O **Desabafo Anônimo** é uma aplicação web simples que permite que pessoas expressem seus sentimentos de forma totalmente anônima.

Usar da tecnologias React e Firebase e publicar no próprio firebase;
...
* Exibir desabafos paginados

**Interações**

* Botão "Eu me identifiquei"
* Botão "Força" Interações
* Botão "Eu acho é pouco"
